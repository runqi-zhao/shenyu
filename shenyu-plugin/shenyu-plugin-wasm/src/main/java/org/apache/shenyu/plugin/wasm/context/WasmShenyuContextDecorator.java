...
package org.apache.shenyu.plugin.wasm.context;
...
public class WasmShenyuContextDecorator implements ShenyuContextDecorator {
    ...
    public ShenyuContext decorator(final ShenyuContext shenyuContext, final MetaData metaData) {
        ...
        shenyuContext.setModule(String.format("%s-%s", PluginEnum.WASM.getName(), shenyuContext.getRpcType()));
