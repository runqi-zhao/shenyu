...
public abstract class WasmPlugin extends AbstractShenyuPlugin {

    protected final Instance instance;

    public WasmPlugin() throws IOException, URISyntaxException {
        // locate `.wasm` lib.
        final Class<? extends WasmPlugin> clazz = this.getClass();
...
//    @Override
//    protected Mono<Void> doExecute2(final ServerWebExchange exchange, final ShenyuPluginChain chain, final SelectorData selector, final RuleData rule) {
